...
/**
 * [실습4] 출판물 장바구니 기능을 구현한 클래스.
 */
public class ShoppingCart {

    private List<Publication> items; // 장바구니에 담긴 출판물 목록
    ...
    /** 장바구니에 있는 모든 출판물의 원래 가격 합계를 반환한다. */
    ...
    /**
     * 출판물 타입별로 다른 할인율을 적용한 총 할인가를 반환한다.
     *   Magazine      : 10% 할인
     *   Novel         : 15% 할인
     *   ReferenceBook : 20% 할인
     *   기타          : 할인 없음
    ...
    /** 장바구니에 담긴 출판물들의 타입별 수량 통계를 출력한다. */
